...
class _HealthAppState extends State<HealthApp> {
  ...
  Future fetchData() async {
    ...
    print("start get Permisiion");
    var loc = await Permission.location.request();
    var act = await Permission.activityRecognition.request();
    print("loc per : "+loc.isGranted.toString());
    print("act per : "+act.isGranted.toString());
    if (requested) {
      try {
        // fetch health data
  ...
  Future fetchStepData() async {
    ...
    if (requested) {
      ...
      //1081295652714-kkrus26kbokrvbji8i7puap6426i8sbr.apps.googleusercontent.com
      //1081295652714-r7ufeuo41ii21cibhki1ge80j6gqrj6q.apps.googleusercontent.com
